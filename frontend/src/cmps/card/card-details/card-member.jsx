...
import { closeActionModal, OpenActionModal } from "../../../store/actions/board.action"
  ...
  return (
    <article>
      ...
      <div className="card-member">
        ...
        <button ref={buttonRef} onClick={!isActionModal ? (ev) => OpenActionModal(ev, "add-members2") : closeActionModal}>
          {isActionModal && (
            <DynamicActionModal
              card={card}
              setCard={setCard}
