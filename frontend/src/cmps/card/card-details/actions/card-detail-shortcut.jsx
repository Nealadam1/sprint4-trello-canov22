...
import { OpenActionModal, openCardDetail, setCardToStoreRef, setGroup, updateCard } from "../../../../store/actions/board.action";
    ...
    return (
        <section className="card-detail-shorcut" ref={cardRef}>
            <div className="card-detail-shortcut-menu">
                {isUseRef && <DynamicMenuPosition cardRef={cardRef.current}>
                    <ul className="shortcut-actions">
                        <li>
                            <Link onClick={handleOpenCard}
                        ...
                        <li className="shortcut-menu-btn"
                            ref={buttonRefCover}
                            onClick={
                                !isActionModal
            ...
            <div>
                ...
                <CardPreviewShortcut card={currCard} title={title} setTitle={setTitle} />
...
const DynamicMenuPosition = (props) => {
    ...
    const [modalStyles, setModalStyles] = useState({
        ...
        left: `calc(${cardRef.getBoundingClientRect().left}px + ${cardRef.offsetWidth}px)`,
        width: "140px",
    })
